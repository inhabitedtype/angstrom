...
type 'a t = { run : 'r. ('r failure -> ('a, 'r) success -> 'r state) with_state }

let fail_k input pos _ marks msg =
  Fail (pos - Input.client_committed_bytes input, marks, msg)
;;
        ...
        (fun input pos more fail succ ->
          let succ1 input1 pos1 more1 m1 =
            let succ2 input2 pos2 more2 m2 =
              let succ3 input3 pos3 more3 m3 = succ input3 pos3 more3 (f m1 m2 m3) in
              m3.run input2 pos2 more2 fail succ3
            in
            m2.run input1 pos1 more1 fail succ2
          in
          m1.run input pos more fail succ1)
          ...
          let succ1 input1 pos1 more1 m1 =
            let succ2 input2 pos2 more2 m2 =
              let succ3 input3 pos3 more3 m3 =
                let succ4 input4 pos4 more4 m4 = succ input4 pos4 more4 (f m1 m2 m3 m4) in
                m4.run input3 pos3 more3 fail succ4
              in
              m3.run input2 pos2 more2 fail succ3
            in
            m2.run input1 pos1 more1 fail succ2
