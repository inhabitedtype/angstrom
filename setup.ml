...
(* OASIS_START *)
(* DO NOT EDIT (digest: 99a51e79bd2e498745a71d3a8f5a28be) *)
(*
...
let setup_t =
  {
               ...
               Library
                 ({
                   ...
                   },
                   {
                      ...
                      lib_pack = false;
                      lib_internal_modules = ["Angstrom_cstruct"];
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "D\243l\138\237!D\193\170\130GH\146\148\189\t";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
